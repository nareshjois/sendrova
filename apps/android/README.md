...
**Version:** `1.0.0` (`versionName`) / `versionCode` `10000` — aligned with desktop stable baseline.
...
CI publishes a **signed release** APK as **`Sendrova-SMS-1.0.0.apk`** (version from `versionName`) on [GitHub Releases](https://github.com/nareshjois/sendrova/releases). Prefer the Release asset for sideload unless you are iterating on the Kotlin app.
